...
@task # Airflow task decorator to define a task in the DAG
def staging_table(): # Airflow task function to update the staging table with data from the YouTube API
    ...
    try:
        ...
        table_ids = get_video_ids(cur=cur, schema=schema)
